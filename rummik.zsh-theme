...
PS1="$PS1:${fg[gray]}%~\$(git_prompt_info)\$(git_prompt_status)%{$fg_bold[black]%}>$reset_color "
PSMIN="%(!.${fg_bold[red]}$.${fg_bold[$(_colorize $USER)]}#)${fg_bold[$(_colorize $HOST)]}%%${fg_bold[black]}\$(git_prompt_info)\$(git_prompt_status)%{$fg_bold[black]%}> $reset_color"
